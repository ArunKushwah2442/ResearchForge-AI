...
# ── Page config ──────────────────────────────────────────────────────────────
st.set_page_config(
    page_title="ResearchForge AI · Research Agent",
    page_icon="🔬",
    layout="wide",
...
<div class="hero">
    ...
    <h1>Research<span>Forge AI</span></h1>
    <p class="hero-sub">
       Four specialized AI agents collaborate — searching, analyzing,
      writing, and critiquing — to forge high-quality research reports
     on any topic.
    </p>
</div>
...
if r:
    ...
    if "writer" in r:
        ...
        st.download_button(
            ...
            data=r["writer"],
            file_name=f"ResearchForge_AI_Report_{int(time.time())}.md",
            mime="text/markdown",
        )
...
st.markdown("""
<div class="notice">
    ResearchForge AI · Powered by LangChain Multi-Agent Pipeline · Built with Streamlit
</div>
""", unsafe_allow_html=True)